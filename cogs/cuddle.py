...
class cuddleCog(commands.Cog):
    ...
    async def cuddle(self, ctx: commands.Context, user: discord.Member):
        ...
        if ctx.author == user:
            ...
            with open("files/cuddle_dumb.txt", "r") as f:
                for line in f:
            ...
            with open("files/cuddle_text.txt", "r") as f:
                for line in f:
                    titles_list.append(line.strip())

            with open("files/cuddle_gif.txt", "r") as f:
                for line in f:
...
async def setup(bot):
    await bot.add_cog(cuddleCog(bot))   
